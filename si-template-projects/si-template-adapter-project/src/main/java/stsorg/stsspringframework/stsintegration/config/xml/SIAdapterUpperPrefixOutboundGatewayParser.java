...
import stsorg.stsspringframework.stsintegration.outbound.SIAdapterUpperPrefixOutboundGateway;
...
public class SIAdapterUpperPrefixOutboundGatewayParser extends AbstractConsumerEndpointParser  {
	...
	protected BeanDefinitionBuilder parseHandler(Element gatewayElement, ParserContext parserContext) {
		...
		IntegrationNamespaceUtils.setValueIfAttributeDefined(siAdapterLowerPrefixOutboundGatewayBuilder, gatewayElement, "reply-timeout");
		...
		IntegrationNamespaceUtils.setValueIfAttributeDefined(siAdapterLowerPrefixExecutorBuilder, gatewayElement, "exsample-property");
